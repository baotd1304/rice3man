...
class LoginRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'phone' => ['sometimes', 'required', 'string', 'exists:users,phone'],
    ...
    {
        return [
            'email.required' => 'Bạn chưa nhập email hoặc số điện thoại',
            'phone.required' => 'Bạn chưa nhập email hoặc số điện thoại',
